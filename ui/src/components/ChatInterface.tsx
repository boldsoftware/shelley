          ...
          <div ref={overflowMenuRef} className="chat-overflow-menu-wrapper">
            ...
            {showOverflowMenu && (
              <AppOverflowMenu
                ...
                onOpenDiffs={
                  currentConversation?.cwd || selectedCwd ? () => setShowDiffViewer(true) : undefined
                }
                onOpenTerminal={
                  terminalURL
                    ? () => {
                ...
                onOpenAgentsMd={() => setShowAgentsMdEditor(true)}
                browserNotifsEnabled={browserNotifsEnabled}
                browserNotificationsDenied={getBrowserNotificationState() === "denied"}
